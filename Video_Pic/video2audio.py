...
video_path = r"D:\MyFiles\Downloads\Video\相声小品全集\已筛选小品"
...
for root, dirs, files in os.walk(video_path):
    ...
    for file in files:
        ...
        if file_name[1] == '.mp4':    # 如果后缀名为 .mp4
            ...
            cmd = ffmpeg + " -i " + os.path.join(root, file) +  " -vn -sn -c:a copy -y -map 0:a:0 " + os.path.join(video_path, file_name[0] + '.aac')
            os.system(cmd)
